...
This report summarizes a concept program for an app that labels beer by a picture and retrieves information about the beer 
from BrweryDB's API. This concept program will utilize SciKit Learn, Tensorflow and Keras for the machine learning model, 
